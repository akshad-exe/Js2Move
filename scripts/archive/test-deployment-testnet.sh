#!/bin/bash
# Test Move package deployment to Movement testnet

set -e

echo "🚀 Movement CLI Testnet Deployment Test"
echo "========================================"
...
# Step 7: Publish to testnet
echo -e "${BLUE}Step 7: Publishing to Movement testnet...${NC}"
